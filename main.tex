...
\begin{frame}[fragile]{Что такое typemap [1]}
...
%        \vspace{0.1cm}
%        \footnotesize
%        \$var - имя входной или выходной переменной
%
%        \$type - исходный C тип параметра (Foo::Bar -> Foo\_Bar)
%
%        \$arg - ячейка стека, для чтения/записи
%    }
\end{frame}

\begin{frame}[fragile]{Что такое typemap [2]}
    \centering
    \hspace{0.5cm}
...
\begin{frame}[fragile]{Немного про OUTPUT [1]}
...
\begin{frame}[fragile]{Немного про OUTPUT [2]}
    \inputcode{XStypemap}{snippets/xs-5-fooGet-typemap}
\end{frame}


\begin{frame}[fragile]{Немного про OUTPUT [3]}
