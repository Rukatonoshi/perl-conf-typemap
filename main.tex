...
\begin{frame}[fragile]{Что такое typemap [1]}
    \begin{itemize}
        ...
        \item Описывает как осуществлять преобразования между Perl-типами/C-типами и обратно
        \item Состоит из трёх секций: TYPEMAP, INPUT и OUTPUT
    \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Выводы}
    В простом случае можно описывать код в функциях на Си и использовать T\_PACKED\\
